...
ativos = {
    ...
    'SANB3':  {'quantidade': 49,         'porcentagem': (0.4 * 0.28 * (1 / 3)),  'tipo': 'BR', 'preco': 0},
    'AESB3':  {'quantidade': 20,         'porcentagem': (0.4 * 0.45 * (1 / 5)),  'tipo': 'BR', 'preco': 0},
    'AURE3':  {'quantidade': 53,         'porcentagem': (0.4 * 0.45 * (1 / 5)),  'tipo': 'BR', 'preco': 0},
    'CMIG4':  {'quantidade': 46,         'porcentagem': (0.4 * 0.45 * (1 / 5)),  'tipo': 'BR', 'preco': 0},
    'TAEE3':  {'quantidade': 68,         'porcentagem': (0.4 * 0.45 * (1 / 5)),  'tipo': 'BR', 'preco': 0},
    'TRPL4':  {'quantidade': 27,         'porcentagem': (0.4 * 0.45 * (1 / 5)),  'tipo': 'BR', 'preco': 0},
    ...
    'VILG11': {'quantidade': 6,          'porcentagem': (0.25 * 0.18 * (1 / 2)), 'tipo': 'BR', 'preco': 0},
    'BRCR11': {'quantidade': 10,         'porcentagem': (0.25 * 0.18 * (1 / 2)), 'tipo': 'BR', 'preco': 0},
    ...
    'VOO':    {'quantidade': 0,          'porcentagem': (0.2 * 0.5),             'tipo': 'US', 'preco': 0},
    'BIL':    {'quantidade': 0,          'porcentagem': (0.2 * 0.30),            'tipo': 'US', 'preco': 0},
    'VNQ':    {'quantidade': 0,          'porcentagem': (0.2 * 0.20),            'tipo': 'US', 'preco': 0},
